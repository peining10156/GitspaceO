...
/*
*
*返回商品列表页里的ShopCategory列表二级或者一级，以及区域信息列表
*
* @param request
* return
* */
@RequestMapping(value = "/listshopspageinfo",method = RequestMethod.GET)
    ...
    /*
    * 组合查询条件，并将条件封装到shopCondition并返回
    * @param parentId
    ...
    * */
    ...
    private Shop compactShopCondition4Serch(long parentId, long shopCategoryId, int areaId, String shopName) {
        ...
        if (parentId !=-1L){
            //查询某个以及shopCategory下面的所有二级ShopCategory里面的店铺列表
